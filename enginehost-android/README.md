...
library `org.godotengine:godot:4.6.3.stable`, pairs them with a native engine
...
The capability covers the Godot 4.6 series while retaining 4.6.3 as the exact
